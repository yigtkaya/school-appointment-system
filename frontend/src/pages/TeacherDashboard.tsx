...
import { ScheduleView } from '../components/TeacherDashboard/ScheduleView';
...
type TabType = 'appointments' | 'schedule' | 'slots' | 'students' | 'profile';
        ...
        <div className="mt-6">
          ...
          {activeTab === 'schedule' && (
            <ScheduleView
              ...
              isLoading={appointmentsQuery.isLoading || slotsQuery.isLoading}
